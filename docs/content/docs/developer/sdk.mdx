...
The SDK is **automatically deployed** to all backend servers (Paper, Purpur, Leaf, Folia, Spigot) via the `templates/global/plugins/` directory. You don't need to install it manually.
